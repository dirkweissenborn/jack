...
class SingleSupportFixedClassAssertionMixin:
    @property
...
class NLIAssertionModelTorch(SingleSupportFixedClassAssertionMixin, PyTorchModelModule):
    def __init__(self, shared_resources, question_embedding_matrix=None, support_embedding_matrix=None):
        ...
        super(NLIAssertionModelTorch, self).__init__(shared_resources)

    def create_prediction_module(self, shared_resources: SharedResources) -> nn.Module:
        return SingleSupportAssertionClassificationModule(shared_resources)

    def create_loss_module(self, shared_resources: SharedResources) -> nn.Module:
        return MyCrossEntropyLoss()
