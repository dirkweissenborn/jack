...
@extractive_qa_reader
def hierarchical_selfattn_qa_reader(resources_or_conf: Union[dict, SharedResources] = None):
    from projects.noninteractive_qa.model import HierarchicalSelfAttnQAModule
    return _tf_extractive_qa_reader(HierarchicalSelfAttnQAModule, resources_or_conf)


@extractive_qa_reader
def hierarchical_gcn_qa_reader(resources_or_conf: Union[dict, SharedResources] = None):
    from projects.noninteractive_qa.model import HierarchicalGCNQAModule
    return _tf_extractive_qa_reader(HierarchicalGCNQAModule, resources_or_conf)


@extractive_qa_reader
def symbolic_segment_qa_reader(resources_or_conf: Union[dict, SharedResources] = None):
    from projects.noninteractive_qa.model import SymbolicSegmentQAModule
    return _tf_extractive_qa_reader(SymbolicSegmentQAModule, resources_or_conf)
