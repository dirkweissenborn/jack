...
class BiLSTM(nn.Module):
    ...
    def forward(self, inputs, lengths):
        ...
        new_inputs = torch.index_select(inputs, 0, indices)
        new_lengths = [l.data[0] for l in new_lengths]
        new_inputs = nn.utils.rnn.pack_padded_sequence(new_inputs, new_lengths, batch_first=True)
        ...
        output, (h_n, c_n) = self._bilstm(new_inputs, (start_hidden, start_state))
